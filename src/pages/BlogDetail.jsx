...
//     date: "August 01, 2026",
//     intro:
//       "Ant activity around kitchens, walls, gardens and food storage areas can quickly become frustrating when trails keep returning. Understanding why ants appear and how to control them helps protect your London property.",
//     content: [
//       {
...
//           "Once ants discover a food source, they create trails that allow more ants to follow. This is why ant activity can appear again even after cleaning the visible insects.",
//         ],
//       },
//       {
...
//           "If the nest or entry route is not identified, the activity can continue and spread to other parts of the property.",
//         ],
//       },
//       {
...
//           "Remove crumbs from kitchen floors, counters and cupboards.",
//           "Identify where ants are entering the property.",
//           "Seal small gaps around doors, floors and walls.",
//           "Contact The Prompt Pest Control for professional ant control support.",
//         ],
//       },
//     ],
//   },
...
//     date: "July 28, 2026",
//     intro:
//       "A wasp nest close to your property can create safety concerns, especially around gardens, lofts, roofs and wall gaps. Professional support is important when wasps are active near people or building entrances.",
//     content: [
//       {
//         heading: "About Wasp Nest Problems",
//         text: [
//           "Wasps may build nests in lofts, sheds, wall cavities, roof edges, garages and garden structures. Their activity often increases when the nest becomes larger.",
//           "Wasps can become defensive if the nest is disturbed. This makes DIY nest removal risky, especially when the nest is in a difficult or hidden location.",
//         ],
//       },
//       {
//         heading: "Signs of a Wasp Nest",
//         points: [
//           "Heavy wasp activity around one area of the property.",
//           "Wasps repeatedly entering roof gaps, vents or wall holes.",
//           "A visible nest inside a loft, shed, tree or garden area.",
//           "Increased wasp activity near windows, doors or outdoor seating.",
//           "Buzzing sounds from a hidden cavity or roof area.",
//         ],
//       },
//       {
...
//           "Nests near entrances, gardens or work areas can make everyday spaces difficult to use safely.",
//         ],
//       },
//       {
...
//           "Keep children and pets away from the active area.",
//           "Identify the main flight path before professional inspection.",
//           "Call The Prompt Pest Control for safe wasp nest control support.",
//         ],
//       },
//     ],
//   },
...
//     date: "July 25, 2026",
//     intro:
//       "Carpet beetles can damage carpets, clothing, curtains and soft furnishings. Their larvae often hide in quiet fabric areas, making early inspection and treatment important.",
//     content: [
//       {
//         heading: "About Carpet Beetles",
//         text: [
//           "Carpet beetles are small insects whose larvae feed on natural fibres, carpets, clothes, curtains, upholstery and stored fabrics.",
//           "They are often found under furniture, along skirting boards, inside wardrobes, near windows and in quiet areas where fibres, lint and dust collect.",
//         ],
//       },
//       {
//         heading: "Signs of Carpet Beetle Activity",
//         points: [
//           "Damage to carpets, clothes, curtains or soft furnishings.",
//           "Small larvae found around carpet edges or wardrobes.",
//           "Adult beetles appearing near windows or light sources.",
//           "Shed larval skins close to affected fabric areas.",
//           "Thin patches or holes in natural fibre materials.",
//         ],
//       },
//       {
//         heading: "Carpet Beetle Risks",
//         text: [
//           "Carpet beetle larvae can cause visible damage to fabrics and soft furnishings if the activity is not treated.",
//           "Because larvae hide in quiet areas, the problem can continue unnoticed until damage becomes more obvious.",
//         ],
//       },
//       {
//         heading: "Treatment and Prevention Advice",
//         points: [
//           "Vacuum carpet edges, skirting boards and under furniture regularly.",
//           "Check wardrobes, stored fabrics and soft furnishings for larvae.",
//           "Wash or clean affected items where suitable.",
//           "Remove lint, hair and dust from hidden areas.",
//           "Book professional carpet beetle treatment if activity continues.",
//         ],
//       },
//     ],
//   },
...
//     date: "July 22, 2026",
//     intro:
//       "Bird activity around roofs, ledges, balconies and commercial buildings can create noise, mess and property concerns. Identifying the signs early can help property owners choose suitable bird proofing and deterrent solutions.",
//     content: [
//       {
//         heading: "About Bird Problems Around Properties",
//         text: [
//           "Birds such as pigeons and gulls often gather around roofs, ledges, balconies, warehouses, shop fronts and commercial buildings where they can find shelter, food and nesting spaces.",
//           "Regular bird activity may lead to nesting material, droppings and blocked drainage areas. The problem can become more difficult to manage when birds repeatedly return to the same roosting or nesting location.",
//         ],
//       },
//       {
//         heading: "Signs of Bird Activity",
//         points: [
//           "Birds repeatedly gathering on roofs, ledges or balconies.",
//           "Droppings building up around entrances, windows or walkways.",
//           "Nesting material found inside gutters, roof spaces or building gaps.",
//           "Noise from birds early in the morning or inside roof areas.",
//           "Damage or blockage around gutters, vents and drainage points.",
//         ],
//       },
//       {
//         heading: "Bird Problems and Property Risks",
//         text: [
//           "Bird droppings can create an unpleasant appearance and may make entrances, pathways and working areas difficult to keep clean.",
//           "Nesting materials can block gutters or drainage systems, while repeated activity around commercial buildings may affect customer areas, staff access and the appearance of the property.",
//         ],
//       },
//       {
//         heading: "Bird Control and Prevention Options",
//         points: [
//           "Identify the main roosting, feeding and nesting areas.",
//           "Avoid leaving food waste or open bins near the property.",
//           "Keep gutters, roofs and drainage areas clear where safe to do so.",
//           "Use suitable bird proofing or deterrent systems for affected ledges and buildings.",
//           "Contact The Prompt Pest Control for professional bird control guidance and property assessment.",
//         ],
//       },
//     ],
//   },
...
//     date: "July 20, 2026",
//     intro:
//       "Bumble bees are valuable pollinators and often require a careful, responsible approach. Understanding where they nest, how they behave and when guidance may be needed can help protect both people and the bees.",
//     content: [
//       {
//         heading: "About Bumble Bees",
//         text: [
//           "Bumble bees are large, fuzzy bees commonly seen around gardens, flowers, parks and residential properties. They play an important role in pollination and are usually less aggressive than wasps.",
//           "They may create temporary nests in old rodent holes, compost areas, sheds, roof spaces, wall cavities or beneath decking. Most colonies remain active for a limited season before naturally declining.",
//         ],
//       },
//       {
//         heading: "Signs of Bumble Bee Activity",
//         points: [
//           "Large fuzzy bees repeatedly entering the same small gap or opening.",
//           "Bee activity around sheds, decking, roof edges or garden areas.",
//           "A steady flight path leading to a hidden nest location.",
//           "Buzzing sounds from a wall cavity, roof space or enclosed area.",
//           "Several bees gathering around flowers close to the property.",
//         ],
//       },
//       {
//         heading: "Bumble Bee Safety and Concerns",
//         text: [
//           "Bumble bees are generally not aggressive unless their nest is disturbed or they feel threatened. However, they can sting when handled or when people get too close to an active nest.",
//           "Extra care may be needed when a nest is close to entrances, children’s play areas, pets or people with known sting allergies.",
//         ],
//       },
//       {
//         heading: "What To Do Around a Bumble Bee Nest",
//         points: [
//           "Avoid blocking the nest entrance or disturbing the surrounding area.",
//           "Keep children and pets away from the main bee flight path.",
//           "Do not spray chemicals or attempt to remove the nest yourself.",
//           "Allow the colony to remain undisturbed when it is safe and practical.",
//           "Contact The Prompt Pest Control for professional identification and responsible bumble bee guidance.",
//         ],
//       },
//     ],
//   },
...
//           <div className="mt-16 rounded-[3rem] bg-[#002447] p-8 text-center text-white">
